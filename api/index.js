...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.stof_ID AS products.stof AS stof, products.merk_ID AS products.merk AS merk, products.maat_ID AS products.maat AS maat, products.categories_ID AS products.categories AS categories FROM products ORDER BY name desc')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price FROM products WHERE id = products.id')
