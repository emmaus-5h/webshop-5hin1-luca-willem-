...
insert into products (name, description, code, price, categories_id, merk_id) values ('trui', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id.', '816905633-0', 10.5,1 ,2);
...
insert into stof_kleding () values ();
insert into stof_kleding () values ();
insert into stof_kleding () values ();
insert into stof_kleding () values ();
...
insert into categories (soortkleding) values ();
insert into categories (soortkleding) values ();
insert into categories (soortkleding) values ();
insert into categories (soortkleding) values ();
...
insert into stof_kleding (name, description, code, price) values ('lelekijkschoen', 'Nulla ut erat id mauris vulputate elementum. Nullam varius.', '077030122-3', 11);
insert into stof_kleding (name, description, code, price) values ('tomaat, The', 'Pellentesque at nulla. Suspendisse potenti.', '445924201-X', 13.5);
insert into stof_kleding (name, description, code, price) values ('komkommer, el pecador de la pradera', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa.', '693155505-7', 13.5);
insert into stof_kleding (name, description, code, price) values ('kip, A (Almost a Bride)', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.', '686928463-6', 14);
insert into stof_kleding (name, description, code, price) values ('vis', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla.', '492662523-7', 14);
...
insert into product_kleur (product_id, , kleur_id) values (1, 2 );--eerste cijfer is product tweede is kleur
